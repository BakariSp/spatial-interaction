...
import { throttle } from 'lodash'; // Make sure to install lodash
    ...
    throttle(async () => {
      ...
      if (model && video && !video.paused) {
        try {
          ...
          console.log("Processed Hand Data:", handData);
          if (typeof onHandsDetected === 'function') {
